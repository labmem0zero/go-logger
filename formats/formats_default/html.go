...
func (f defaultHTML) String(args ...interface{}) string {
	if len(args) < 6 {
		args = append([]interface{}{time.Now(), "unidentified", "unidentified", "unidentified", "unidentified", "unidentified"}, args)
...
// passing args: timestamp, environment, app_name, app_id, log_level, req_id, args...
